;              
CREATE USER IF NOT EXISTS "SA" SALT '82dfaa23d1904b77' HASH '575ce97a4fb7218d080ed1407bbc4d057eb4498f055205205987e760aa824158' ADMIN;          
CREATE SEQUENCE "PUBLIC"."SYSTEM_SEQUENCE_1887F733_74B0_45D6_A395_0B05105C89A4" START WITH 1 BELONGS_TO_TABLE; 
CREATE SEQUENCE "PUBLIC"."SYSTEM_SEQUENCE_607943DD_92C3_489D_843F_AF70A9A572F4" START WITH 80 BELONGS_TO_TABLE;
CREATE CACHED TABLE "PUBLIC"."INVOLVEMENT"(
    "ID" BIGINT DEFAULT NEXT VALUE FOR "PUBLIC"."SYSTEM_SEQUENCE_1887F733_74B0_45D6_A395_0B05105C89A4" NOT NULL NULL_TO_DEFAULT SEQUENCE "PUBLIC"."SYSTEM_SEQUENCE_1887F733_74B0_45D6_A395_0B05105C89A4",
...
CREATE CACHED TABLE "PUBLIC"."SECTOR"(
    "ID" BIGINT DEFAULT NEXT VALUE FOR "PUBLIC"."SYSTEM_SEQUENCE_607943DD_92C3_489D_843F_AF70A9A572F4" NOT NULL NULL_TO_DEFAULT SEQUENCE "PUBLIC"."SYSTEM_SEQUENCE_607943DD_92C3_489D_843F_AF70A9A572F4",
    "NAME" VARCHAR(255) NOT NULL,
    "PARENT_ID" BIGINT
);   
